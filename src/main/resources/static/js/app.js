...
var app = {
    ...
    URL: {
        ...
        deletePaperQuestionUrl: function () {
            return app.data.contextPath+'/contest/deleteProblem/';
        },
        myContestsUrl: function () {
            return app.data.contextPath+'/mycontest/list';
        },
        enterContestUrl: function () {
            return app.data.contextPath+'/mycontest/joincontest';
        },
    ...
    run: function () {
        ...
        // document.getElementById("current_server_timer").innerHTML = app.formatTime(this.data.nowTime, "Y-M-D h:m:s");
    },
    /**
     * 登录模态框显示
     */
